...
?>
        ...
        <div style="background: #F5F5F5; margin-bottom: 10px; padding: 10px;">
            ...
            <p id="<?php echo $this->get_field_id('img_src_'.$i); ?>">
                <label style="display: block;" for="<?php echo $this->get_field_id('img_src_'.$i); ?>"><?php _e('Nguồn ảnh ', 'rt-theme'); echo $i+1; ?>:</label>
